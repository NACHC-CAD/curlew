...
@Slf4j
public class AddAllDxThumb {

	@Test
	public void shouldUploadFile() {
		log.info("Starting test...");
		String rootDirName = "C:\\_WORKSPACES\\nachc\\_PROJECT\\cosmos\\womens-health\\thumb\\dx";
	...
	public static RawDataFileUploadParams getParams() {
		...
		params.setDataGroupName("Diagnosis");
		params.setDataGroupAbr("dx");
		params.setDatabricksFileLocation("/FileStore/tables/integration-test/womens-health/dx");
