...
@Slf4j
public class AddAllEncThumb {

	@Test
	public void exec() {
		log.info("Starting test...");
		String rootDirName = "C:\\_WORKSPACES\\nachc\\_PROJECT\\cosmos\\womens-health\\thumb\\enc";
	...
	public static RawDataFileUploadParams getParams() {
		...
		params.setDataGroupName("Encounter");
		params.setDataGroupAbr("enc");
		params.setDatabricksFileLocation("/FileStore/tables/integration-test/womens-health/enc");
