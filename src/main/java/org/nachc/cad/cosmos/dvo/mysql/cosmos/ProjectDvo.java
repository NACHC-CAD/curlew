...
public class ProjectDvo implements Dvo {
    ...
    private ArrayList<BlockDefDvo> blockDefProjectList = new ArrayList<BlockDefDvo>();
    ...
    public ArrayList<BlockDefDvo> getBlockDefProjectList() {
        return blockDefProjectList;
    }
    
    public void setBlockDefProjectList(ArrayList<BlockDefDvo> list) {
        this.blockDefProjectList = list;
    }
