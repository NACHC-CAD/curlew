//
// Data Value Object (DVO) for raw_table_group_raw_table
//
...
public class RawTableGroupRawTableDvo implements Dvo {

    //
    // tableName
    //
    
    public static final String TABLE_NAME = "raw_table_group_raw_table";
